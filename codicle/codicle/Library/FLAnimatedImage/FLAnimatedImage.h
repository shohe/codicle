...
//
@interface FLAnimatedImage : NSObject<NSCoding>
...
@property (nonatomic, strong, readwrite) NSArray    *delayTimes; // Of type `NSTimeInterval` boxed in `NSNumber`s
@property (nonatomic, assign, readwrite) NSUInteger frameCount; // Number of valid frames; equal to `[.delayTimes count]`
